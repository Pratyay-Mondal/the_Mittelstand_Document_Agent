...
export const translations = {
  en: {
    ...
    feature2_desc: "Runs on Gemma 4 with local embedding models ensuring data privacy.",
  ...
  de: {
    ...
    feature2_desc: "Läuft auf Gemma 4 mit lokalen Embedding-Modellen und gewährleistet Datenschutz.",
    feature3_title: "Human-in-the-Loop",
